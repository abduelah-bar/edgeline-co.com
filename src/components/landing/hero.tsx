        ...
        <div className="mt-12 grid grid-cols-2 gap-8 w-full max-w-md">
            <AnimatedWrapper delay={0.4}>
              <div className="text-center">
                ...
                <p className="text-primary-foreground mt-1 font-semibold" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.5)' }}>Projects Completed</p>
              </div>
            </AnimatedWrapper>
            <AnimatedWrapper delay={0.6}>
              <div className="text-center">
                ...
                <p className="text-primary-foreground mt-1 font-semibold" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.5)' }}>Happy Clients</p>
              </div>
            </AnimatedWrapper>
        </div>
      </div>
